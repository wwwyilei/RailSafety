...
def segment(sam_predictor: SamPredictor, rail_detector: Detector, image: np.ndarray, detections: sv.Detections) -> np.ndarray:
    ...
    # Then process person and car masks using SAM
...
def find_matching_depth_on_rail(rail_mask, depth_map, target_depth, person_foot_position, tolerance=0.3):
    ...
    matching_indices = np.where(absolute_diff < tolerance *30)[0]
...
def main():
    ...
    config = {
        ...
        'output_path': "D:/GitHub/Railway_Safety_system/evaluation_results",
